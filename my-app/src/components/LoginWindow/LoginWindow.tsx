...
const LoginWindow = ({loginInfo, setUserLogged}) => {
    ...
    return(
        <div className="login-window">
            ...
            <div className='login-inputs-btn'>
                <SingleInput onChange={(e) => setEmail(e.target.value)} value={emailValue} placeholder='Email Address *' variation='login-input' ></SingleInput>
                <SingleInput onChange={(e) => setPassword(e.target.value)} value={passwordValue} placeholder='Password *' variation='login-input' ></SingleInput>
                <Btn onClick={handleLogin} variation='login-btn'>Login</Btn>
            </div>
